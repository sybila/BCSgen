...
rules, state = Import.import_rules("inputs/model1.bcs")
states = {state}
bound = 1
...
# Example 2
rules, state = Import.import_rules("inputs/model2.bcs")
states = {state}
bound = 2
...
# Example 3
rules, state = Import.import_rules("inputs/model3.bcs")
states = {state}
bound = 2
...
# Example 4
rules, state = Import.import_rules("inputs/model4.bcs")
states = {state}
bound = 4
...
# Example 5
rules, state = Import.import_rules("inputs/model5.bcs")
states = {state}
bound = 3
...
# Example 6
rules, state = Import.import_rules("inputs/model6.bcs")
states = {state}
bound = 4
