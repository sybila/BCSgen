...
\begin{tabular}{ c | | c | l }
    ...
    $ \Gamma_\rho = \beta_{\rho_1}::c + \beta_{\rho_2}::c + ~...~+ \beta_{\rho_n}::c $ \\
	 ...
	 &  & $ \mathtt{X}_{\square} = \beta_1.\beta_2.~...~.\beta_m::c $\\
    ...
    $ \Gamma_{\square} = \beta_{\mathtt{C}_1}::c + \beta_{\mathtt{C}_2}::c + ~...~+ \beta_{\mathtt{C}_n}::c $ ~~~~~ $ m \geq n $\\

     &  & $ \mathtt{X} = \beta_1.\beta_2.~...~.\beta_m::c $~ \emph{such that} ~$ \beta_i = \beta_{\mathtt{C}_j} $ \\
