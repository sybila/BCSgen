...
Let $\gamma_p^{r-l}$ is the difference between $\gamma_p^{r}$ and $\gamma_p^{l}$ compositions and $\gamma_p^{l-r}$ is the difference between $\gamma_p^{l}$ and $\gamma_p^{r}$. Then $\gamma_p^{s^-}$ is part of $\gamma_p^{s}$ composition such that there exist relation $\rho \subseteq \gamma_p^{r-l} \bigtimes \gamma_p^{s^-}:$ $\forall~\alpha_1~\in~\gamma_p^{s^-}~\exists~\alpha_2~\in~\gamma_p^{l-r}: (\alpha_1,~\alpha_2)~\in~\rho~\wedge~\alpha_1~\lhd~\alpha_2$. Moreover, $\forall (\alpha, \alpha'), (\beta, \beta') \in \rho: \alpha~\neq~\beta~\Leftrightarrow~\alpha'~\neq~\beta' $.
...
\item $ \mathtt{T}_s[\mathtt{T}_r] = \mathtt{T}_s: \forall (\mathtt{a}_r\{t\},~\mathtt{a}_s\{p\}) \in \rho: \mathtt{a}_s\{p\}[\mathtt{a}_r\{t\}] $

where $\mathtt{T}_s = \tau_s(\gamma_p^{s})$, $\mathtt{T}_l = \tau_l(\gamma_p^{l})$, $\mathtt{T}_r = \tau_r(\gamma_p^{r})$ and $\tau_s = \tau_l = \tau_r$.
