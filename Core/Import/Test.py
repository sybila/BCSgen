...
class TestImport(unittest.TestCase):
    def setUp(self):
        ...
        self.Aagent1 = BCSL.Atomic_Agent('S', ['u'], 'cyt')
        self.Aagent11 = BCSL.Atomic_Agent('S', ['p'], 'cyt')
        self.Aagent2 = BCSL.Atomic_Agent('T', ['u'], 'cyt')
        self.Sagent1 = BCSL.Structure_Agent('KaiC', [self.Aagent1, self.Aagent2], 'cyt')
        self.Sagent2 = BCSL.Structure_Agent('KaiC', [self.Aagent2, self.Aagent1], 'cyt')
        self.Sagent3 = BCSL.Structure_Agent('KaiC', [], 'cyt')
        self.Xagent1 = BCSL.Complex_Agent([self.Sagent1, self.Sagent2], 'cyt')
        self.Rule1 = BCSL.Rule([self.Aagent1], [self.Aagent11])
        self.Aagent3 = BCSL.Atomic_Agent('A', ['i'], 'cyt')
        self.Aagent4 = BCSL.Atomic_Agent('A', ['i', 'a'], 'cyt')
        self.Aagent5 = BCSL.Atomic_Agent('A', ['a'], 'cyt')
        self.Sagent4 = BCSL.Structure_Agent('T', [self.Aagent1, self.Aagent4], 'cyt')
        self.Sagent5 = BCSL.Structure_Agent('T', [self.Aagent1, self.Aagent3], 'cyt')
        self.Sagent6 = BCSL.Structure_Agent('T', [self.Aagent1], 'cyt')
        self.Xagent2 = BCSL.Complex_Agent([self.Sagent1, self.Aagent4, self.Aagent4], 'cyt')
        self.Xagent3 = BCSL.Complex_Agent([self.Sagent1, self.Aagent3, self.Aagent4], 'cyt')
        self.Xagent4 = BCSL.Complex_Agent([self.Sagent1, self.Aagent3, self.Aagent3], 'cyt')
